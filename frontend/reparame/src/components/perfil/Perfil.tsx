    ...
    <section className="flex flex-col gap-10 max-w-max-textArea w-full px-10 pt-10 pb-10 text-light-orange bg-grayUi">
      ...
      <figure className="flex flex-row items-center gap-6">
        <div className="flex flex-row items-end">
          <Image src={'/images/Ellipse 48.png'} alt="avatar User" width={120} height={120} className="border-3 border-dark-orange rounded-full" />
          <button className="bg-dark-orange rounded-full relative right-8 bottom-2">
            <MdModeEdit className='w-6 h-6 text-white p-1' />
          </button>
        </div>
        <figcaption className="text-2xl text-dark-orange">{userLog.nombreCompleto + ' ' + userLog.apellidoCompleto}</figcaption>
      </figure>
      <article className="flex flex-col gap-5 items-center">
        <textarea name="" placeholder="Descripción" className="text-grayText outline-none w-full p-5 h-52 shadow-cardsPerfil rounded resize-none"></textarea>
      ...
      <section>
        ...
        <div className="flex md:flex-row flex-col gap-10 ">
          <label className="bg-white flex flex-row gap-5 p-5 w-48 shadow-cardsPerfil rounded ">
            Min $
            <input type="text" placeholder={'100'} className="w-20 text-grayText" />
          </label>
          <label className="bg-white flex flex-row gap-5 p-5 w-48 shadow-cardsPerfil rounded">
            Max $
            <input type="text" placeholder={'1500'} className="w-20 text-grayText" />
          </label>
        </div>
      </section>
