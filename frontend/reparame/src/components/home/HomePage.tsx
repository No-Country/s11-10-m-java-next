    ...
    <section className="max-w-max-view w-full">
      ...
      <section className="w-full flex mt-10 mb-20 flex-col text-center">
        <h2 className="font-semibold text-3xl mb-16">
          La solucion que buscas, en tres pasos:
        </h2>
        <div className="flex justify-center gap-40">
          <div className="text-center flex flex-col gap-4">
            <figure className="flex items-center">
              <span className="bg-light-orange shadow-spanCircle px-4 py-1 rounded-full relative left-6 text-white text-4xl font-extrabold">
                1
              </span>
            ...
            <p className="pl-5 text-3xl font-medium">
              Buscá el <br /> servicio
            </p>
          </div>

          <div className="text-center flex flex-col gap-4">
            <figure className="flex items-center">
              <span className="bg-light-orange shadow-spanCircle px-3 py-1 rounded-full relative left-6 text-white text-4xl font-extrabold">
                2
              </span>
              <div className="bg-white shadow-circle w-60 h-60 rounded-full flex items-center justify-center">
      ...
      <section className="w-full bg-mega-light-orange py-16">
        <p className="text-center font-semibold text-4xl mb-10">
          ¿Queres tener más alcance? Convertite en PREMIUM
        </p>
        <div className="flex justify-center mr-32 gap-20">
          ...
          <div className=" flex flex-col justify-center items-center text-center gap-7">
            <p className=" text-xl font-medium">
              Hacete Premium por solo $999,- pesos al mes y <br /> aprovechá
        ...
        <div className="flex place-content-center">
          <Link
            href=""
            className="text-[#F60] bg-[#F5F5F5] text-2xl px-10 py-3"
          >
            contactanos
          </Link>
        </div>
